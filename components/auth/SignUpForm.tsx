  ...
  return (
    <div className="flex w-full flex-col items-center justify-center px-9 sm:w-[480px] sm:px-0">
      ...
      <div className="flex w-full flex-col gap-1.5 py-6">
        ...
        <p className="font-type-body text-fs-100 text-muted-foreground">Create your workspace</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex w-full flex-col gap-3">
        <Input
          ...
          className="h-11 font-type-body text-fs-100"
        />
        <InputAction
          type="email"
          required
        ...
        <button
          ...
          aria-hidden
        />
        <p className="font-type-body text-fs-75 text-muted-foreground">
